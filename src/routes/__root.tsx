...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ClicVenda — Tire pedidos em segundos" },
      { property: "og:description", content: "App de pedidos para distribuidoras e indústrias B2B com integração nativa ao seu ERP." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ClicVenda — Tire pedidos em segundos" },
      { name: "twitter:description", content: "App de pedidos para distribuidoras e indústrias B2B com integração nativa ao seu ERP." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4710683e-dbc7-4e85-8584-85552bcfc048/id-preview-65526d74--3553a92f-c9bc-44b4-84e1-8f603aa4a392.lovable.app-1778115446431.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4710683e-dbc7-4e85-8584-85552bcfc048/id-preview-65526d74--3553a92f-c9bc-44b4-84e1-8f603aa4a392.lovable.app-1778115446431.png" },
    ],
    links: [
      ...
      <body>
        <noscript>
          <img height="1" width="1" style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=205366881720928&ev=PageView&noscript=1" alt="" />
        </noscript>
        {children}
        <Scripts />
      </body>
